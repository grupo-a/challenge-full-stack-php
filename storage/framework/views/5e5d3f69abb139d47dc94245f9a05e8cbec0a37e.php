...
<style>
    ...
    .sidenav {
        height: 100%;
        background-image: url(<?php echo e(url('storage/login_background.jpg')); ?>);
        overflow-x: hidden;
        padding-top: 20px;
    }
...
<?php /**PATH C:\wamp64\www\challenge-full-stack-php\resources\views/pages/login.blade.php ENDPATH**/ ?>